				...
				<nav class="d-flex justify-content-center" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						if(isset($_GET['tanggal'])){
							echo '
							<li class="breadcrumb-item"><a href="barang_laku1.php">Entry Penjualan</a></li>
							<li class="breadcrumb-item active" aria-current="page">Data Penjualan Tanggal '. $_GET["tanggal"].'</li>';
						}else{
							echo'
