...
$pdf->Image('../logo/foto.png',1,1,2,2);
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'RazorMart',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 085858298649',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Permai 4 No.28',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'email : razormart@gmail.com',0,'L');
...
$pdf->Output("laporan_penjualan_barang.pdf","I");
?>
