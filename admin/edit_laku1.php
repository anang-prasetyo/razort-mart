		...
		<section>
			<div class="text-center py-4">
				...
				<div class="d-flex justify-content-center" style="margin: 2rem 0;">
					<button class="buttonku-1" onclick="window.location.href='barang_laku1.php';"><i class="bi-arrow-left me-2"></i> Kembali</button>
				</div>
				</div>
			</div>
		</section>
		<section>
			<div class="s2">
				...
				while($d=mysqli_fetch_array($det)){
					?>					
					<form action="update_laku1.php" method="post">
						<table class="table">
							<tr>
